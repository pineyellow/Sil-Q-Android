...
void print_rel(char c, byte a, int y, int x)
{
    ...
    extern void android_camera_effect(int y, int x, byte a, char c);
    android_camera_effect(y, x, a, c);
#endif
    int ky, kx;
    int vy, vx;
...
{
#if defined(__ANDROID__) && defined(USE_SDL)
    extern void android_camera_clear_effect(int y, int x);
    android_camera_clear_effect(y, x);
#endif
    byte a;
    char c;
    byte ta;
...
{
#if defined(__ANDROID__) && defined(USE_SDL)
    extern void android_camera_clear_effects(void);
